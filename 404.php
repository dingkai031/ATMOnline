...
<!-- Loader ends -->
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-12 page-content position-relative">
                  <h2 class="text-white mt-5 mb-2 font-secondary">404 Error</h2>
                  <p class="text-white">We offer the most creative web designs.</p>
                  <div class="page_nav d-inline-block">
    ...
    <section id="error" class="text-left">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center no-transition">
                    <div class="error wow bounceIn" data-wow-delay="300ms">
                        <h1 class="color-vlight-grey2 font-secondary">404</h1>
                        <h2 class="color-grey font-secondary font-weight-600">404</h2>
                    </div>
                    <p class="heading-space font-16">We are sorry, the page you want isn’t here anymore. May be one of the links below can help !</p>
                    <a href="<?php echo BASE_URL."page_check.php?page=index" ?>" class="btn-setting btn-hvr-setting-main btn-pink text-white btn-hvr">Back to home
